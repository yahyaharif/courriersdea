...
use DEA\CourriersBundle\Entity\Service;
use DEA\CourriersBundle\Form\ServiceType;
...
class ServiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CourriersBundle:Service')->findAll();

        return $this->render('CourriersBundle:Service:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CourriersBundle:Service:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CourriersBundle:Service')->find($id);
        ...
        return $this->render('CourriersBundle:Service:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CourriersBundle:Service:edit.html.twig', array(
            'entity'      => $entity,
