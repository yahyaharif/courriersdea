...
use DEA\CourriersBundle\Entity\Division;
use DEA\CourriersBundle\Form\DivisionType;
...
class DivisionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CourriersBundle:Division')->findAll();

        return $this->render('CourriersBundle:Division:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CourriersBundle:Division:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CourriersBundle:Division')->find($id);
        ...
        return $this->render('CourriersBundle:Division:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CourriersBundle:Division:edit.html.twig', array(
            'entity'      => $entity,
